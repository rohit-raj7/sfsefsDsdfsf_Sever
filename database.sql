...
CREATE TABLE IF NOT EXISTS listener_withdrawal_requests (
    ...
    tds_amount DECIMAL(12, 2) NOT NULL DEFAULT 0 CHECK (tds_amount >= 0),
    transaction_fee DECIMAL(12, 2) NOT NULL DEFAULT 0 CHECK (transaction_fee >= 0),
    final_credit_amount DECIMAL(12, 2) NOT NULL DEFAULT 0 CHECK (final_credit_amount >= 0),
